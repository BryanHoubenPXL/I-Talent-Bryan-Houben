  ...
  return (
    <div className="about-container">
        ...
        <div className="about-buttons">
            ...
            <a href="/files/thalento.pdf" target="_blank" rel="noopener noreferrer">Mijn Thalento</a>
            <a href="/files/italent.pdf" target="_blank" rel="noopener noreferrer">Mijn Portfolio</a>
        </div>
    </div>
  )
}
